...
const TreeItem = React.memo(({ port, depth, mutationHandler, isLastRoot }) => {
    ...
    return (_jsxs("div", { className: itemWrapperClasses, tabIndex: 0, onBlur: (e) => {
            if (!e.currentTarget.contains(e.relatedTarget))
                setIsSelected(false);
        }, children: [depth > 0 && (_jsxs(_Fragment, { children: [_jsx("div", { className: `connector-h ${isSelected ? "connector-selected" : ""}` }), _jsx("div", { className: `connector-v ${isSelected ? "connector-selected" : ""} ${isLastRoot ? "connector-v-last" : ""}` })] })), isRoot && !isLastRoot ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "root-item-connector-v" }), _jsx("div", { className: "root-item-connector-h" })] })) : (_jsx(_Fragment, { children: _jsx("div", { className: "root-item-connector-h-last" }) })), _jsxs("div", { className: itemContentClasses, onClick: (e) => {
                    e.stopPropagation();
                    setIsSelected(true);
